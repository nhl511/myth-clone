      ...
      >
        ...
        <TooltipTrigger asChild>
          <SliderPrimitive.Thumb
            ...
            } block h-4 w-4 rounded-full border-none bg-primary shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50`}
          />
        </TooltipTrigger>
